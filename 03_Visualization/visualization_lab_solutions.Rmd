---
title: 'Lab Solutions: Data Visualization'
...
Then, we want to create the histogram. We can specify better titles using `ggtitle`, `xlab`, and `ylab`. 

```{r}
georgia_counties_may9 %>% 
  ggplot(aes(x = cases)) + geom_histogram(color = "black") + 
  ggtitle("Distribution of county cases") + xlab("Cases") + ylab("")
```
